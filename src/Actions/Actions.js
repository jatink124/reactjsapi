...
class Actions extends React.Component{
    ...
    fetchUsers = () => {
        Axios.get('https://www.catchmyjob.in/php-react/all-users.php')
        .then(({data}) => {
            if(data.success === 1){
                this.setState({
    ...
    handleUpdate = (id,user_name,user_email) => {
        Axios.post('https://www.catchmyjob.in/php-react/update-user.php',
        {
            id:id,
            user_name:user_name,
    ...
    handleDelete = (id) => {
        ...
        Axios.post('https://www.catchmyjob.in/php-react/delete-user.php',{
            id:id
        })
        .then(({data}) => {
            if(data.success === 1){
    ...
    insertUser = (event,user_name,user_email) => {
        ...
        event.persist();
        Axios.post('https://www.catchmyjob.in/php-react/add_user.php',{
            user_name:user_name,
            user_email:user_email
        })
        .then(function ({data}) {
